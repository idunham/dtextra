...
"MGv*mainWindow.toolBar.imagePath: /opt/mgv/share/mgv/3.1.5/toolbar",
"MGv*mainWindow.toolBar.tipFontList: -*-helvetica-medium-r-normal--10-*-*-*-*-*-iso8859-1",
"MGv*toolBar*fileOpen.newGroup:    true",
"MGv*toolBar*fileOpen.toolBarIcon: INTERNAL::fileOpen",
"MGv*toolBar*fileOpen.toolTip:     Open a new PostScript file",
"MGv*toolBar*fileOpen.labelString:",
"MGv*toolBar*filePrint.toolBarIcon: INTERNAL::filePrint",
"MGv*toolBar*filePrint.toolTip:     Print the file",
"MGv*toolBar*filePrint.labelString:",
"MGv*toolBar*mark.newGroup:    true",
"MGv*toolBar*mark.toolBarIcon: INTERNAL::mark",
"MGv*toolBar*mark.toolTip:     (Un)Mark Page",
"MGv*toolBar*mark.labelString:",
"MGv*toolBar*markAll.toolBarIcon: INTERNAL::markAll",
"MGv*toolBar*markAll.toolTip:     Mark All Pages",
"MGv*toolBar*markAll.labelString:",
"MGv*toolBar*markNone.toolBarIcon: INTERNAL::markNone",
"MGv*toolBar*markNone.toolTip:     Unmark All Pages",
"MGv*toolBar*markNone.labelString:",
"MGv*toolBar*markEven.toolBarIcon: INTERNAL::markEven",
"MGv*toolBar*markEven.toolTip:     Mark Even Pages",
"MGv*toolBar*markEven.labelString:",
"MGv*toolBar*markOdd.toolBarIcon: INTERNAL::markOdd",
"MGv*toolBar*markOdd.toolTip:     Mark Odd Pages",
"MGv*toolBar*markOdd.labelString:",
"MGv*toolBar*magstepIncr.newGroup:    true",
"MGv*toolBar*magstepIncr.toolBarIcon: INTERNAL::magstepIncr",
"MGv*toolBar*magstepIncr.toolTip:     Increase Magstep",
"MGv*toolBar*magstepIncr.labelString:",
"MGv*toolBar*magstepDecr.toolBarIcon: INTERNAL::magstepDecr",
"MGv*toolBar*magstepDecr.toolTip:     Decrease Magstep",
"MGv*toolBar*magstepDecr.labelString:",
"MGv*toolBar*helpContext.newGroup:    true",
"MGv*toolBar*helpContext.toolBarIcon: INTERNAL::helpContext",
"MGv*toolBar*helpContext.toolTip:     Context Help",
"MGv*toolBar*helpContext.labelString:",
"MGv*toolBar*pagePrev.newGroup:    True",
"MGv*toolBar*pagePrev.toolBarIcon: INTERNAL::pagePrev",
"MGv*toolBar*pagePrev.toolTip:     Previous Page",
"MGv*toolBar*pagePrev.labelString:",
"MGv*toolBar*pageNext.toolBarIcon: INTERNAL::pageNext",
"MGv*toolBar*pageNext.toolTip:     Next Page",
"MGv*toolBar*pageNext.labelString:",
"MGv*helpBrowser:	netscape",
"MGv*helpType:		html-remote",
"MGv*helpPrefix:		file:///opt/mgv/share/mgv/3.1.5/help/",
"MGv*installIcon:	True",
"MGv*useColorIcon:	True",
"MGv*wlShowSplashScreen:	True",
"MGv*wlSplashPixmap:	/opt/mgv/share/mgv/3.1.5/splash.xpm",
"MGv*wlSplashBitmap:	/opt/mgv/share/mgv/3.1.5/splash.xbm",
...
"MGv*mark_pd*mark.helpChapter:			mgv-6",
...
"MGv*mark_pd*markAll.helpChapter:		mgv-6",
"MGv*menuBar*mark_pd*markNone.labelString:	Unmark All",
"MGv*menuBar*mark_pd*markNone.mnemonic:		U",
"MGv*menuBar*mark_pd*markNone.accelerator:	Alt<Key>U",
"MGv*menuBar*mark_pd*markNone.acceleratorText:	Alt+U",
"MGv*mark_pd*markNone.helpSection:		mark-all",
"MGv*mark_pd*markNone.helpChapter:		mgv-6",
...
"MGv*mark_pd*even.helpChapter:			mgv-6",
...
"MGv*mark_pd*odd.helpChapter:			mgv-6",
...
"MGv*mark_pd*invert.helpChapter:			mgv-6",
...
"MGv*magstep_pd*0.helpChapter:			mgv-7",
"MGv*menuBar*magstep_pd*1.labelString:	+1",
"MGv*magstep_pd*1.helpSection:		magstep-numbers",
"MGv*magstep_pd*1.helpChapter:		mgv-7",
"MGv*menuBar*magstep_pd*2.labelString:	+2",
...
"MGv*magstep_pd*increase.helpChapter:			mgv-7",
...
"MGv*magstep_pd*set.helpChapter:			mgv-7",
...
"MGv*orientation_pd*portrait.helpChapter:		mgv-8",
...
"MGv*orientation_pd*landscape.helpChapter:		mgv-8",
...
"MGv*orientation_pd*upsideDown.helpChapter:		mgv-8",
...
"MGv*orientation_pd*seascape.helpChapter:		mgv-8",
...
"MGv*options_pd*antiAlias.helpChapter:			mgv-10",
...
"MGv*options_pd*magicScroll.helpChapter:			mgv-10",
...
"MGv*options_pd*smoothScroll.helpChapter:		mgv-10",
...
"MGv*options_pd*smartSizing.helpChapter:			mgv-10",
"MGv*menuBar*palette_pd.radioBehavior:	True",
"MGv*menuBar*palette_pd.helpChapter:	mgv-10",
"MGv*menuBar*palette.labelString:	Color Palette",
"MGv*menuBar*palette.mnemonic:		C",
"MGv*options_pd*palette.helpChapter:	mgv-10",
...
"MGv*palette_pd*monochrome.helpChapter:			mgv-10",
...
"MGv*palette_pd*grayscale.helpChapter:		mgv-10",
...
"MGv*palette_pd*color.helpChapter:		mgv-10",
"MGv*menuBar*view_pd*hideLog.labelString:	Hide Log",
"MGv*menuBar*view_pd*hideLog.mnemonic:		L",
"MGv*menuBar*view_pd*hideLog.accelerator:	Ctrl<Key>L",
"MGv*menuBar*view_pd*hideLog.acceleratorText:	Ctrl+L",
"MGv*view_pd*hideLog.helpSection:		view-hidelog",
"MGv*view_pd*hideLog.helpChapter:		mgv-5",
"MGv*menuBar*view_pd*hideList.labelString:	Hide Page List",
"MGv*menuBar*view_pd*hideList.mnemonic:		P",
"MGv*menuBar*view_pd*hideList.accelerator:	Ctrl<Key>G",
"MGv*menuBar*view_pd*hideList.acceleratorText:	Ctrl+G",
"MGv*view_pd*hideList.helpSection:		view-hidelist",
"MGv*view_pd*hideList.helpChapter:		mgv-5",
"MGv*menuBar*view_pd*hideStatus.labelString:	Hide Status Line",
"MGv*menuBar*view_pd*hideStatus.mnemonic:	S",
"MGv*menuBar*view_pd*hideStatus.accelerator:	Ctrl<Key>T",
"MGv*menuBar*view_pd*hideStatus.acceleratorText:	Ctrl+T",
"MGv*view_pd*hideStatus.helpSection:		view-hidestatus",
"MGv*view_pd*hideStatus.helpChapter:		mgv-5",
"MGv*menuBar*view_pd*hideMenu.labelString:	Hide Menu Bar",
"MGv*menuBar*view_pd*hideMenu.mnemonic:		M",
"MGv*menuBar*view_pd*hideMenu.accelerator:	Ctrl<Key>B",
"MGv*menuBar*view_pd*hideMenu.acceleratorText:	Ctrl+B",
"MGv*view_pd*hideMenu.helpSection:		view-hidemenu",
"MGv*view_pd*hideMenu.helpChapter:		mgv-5",
"MGv*menuBar*view_pd*hideToolBar.labelString:		Hide Tool Bar",
"MGv*menuBar*view_pd*hideToolBar.mnemonic:		T",
"MGv*menuBar*view_pd*hideToolBar.accelerator:		Alt<Key>T",
"MGv*menuBar*view_pd*hideToolBar.acceleratorText:	Alt+T",
"MGv*view_pd*hideToolBar.helpSection:			view-hidetoolbar",
"MGv*view_pd*hideToolBar.helpChapter:			mgv-5",
"MGv*menuBar*view_pd*closeZoom.labelString:	Close All Zooms",
"MGv*menuBar*view_pd*closeZoom.mnemonic:		Z",
"MGv*menuBar*view_pd*closeZoom.accelerator:	Ctrl<Key>Z",
"MGv*menuBar*view_pd*closeZoom.acceleratorText:	Ctrl+Z",
"MGv*view_pd*closeZoom.helpSection:		view-closezoom",
"MGv*view_pd*closeZoom.helpChapter:		mgv-5",
...
"MGv*popup*hideLog.helpSection:		view-hidelog",
"MGv*popup*hideLog.helpChapter:		mgv-5",
"MGv*popup*hideList.labelString:		Hide Page List",
"MGv*popup*hideList.mnemonic:		P",
"MGv*popup*hideList.acceleratorText:	Ctrl+G",
"MGv*popup*hideList.helpSection:		view-hidelist",
"MGv*popup*hideList.helpChapter:		mgv-5",
...
"MGv*popup*hideStatus.helpSection:	view-hidestatus",
"MGv*popup*hideStatus.helpChapter:	mgv-5",
"MGv*popup*hideMenu.labelString:		Hide Menu Bar",
"MGv*popup*hideMenu.mnemonic:		M",
"MGv*popup*hideMenu.acceleratorText:	Ctrl+B",
"MGv*popup*hideMenu.helpSection:		view-hidemenu",
"MGv*popup*hideMenu.helpChapter:		mgv-5",
"MGv*popup*hideToolBar.labelString:	Hide Tool Bar",
"MGv*popup*hideToolBar.mnemonic:		T",
"MGv*popup*hideToolBar.acceleratorText:	Alt+T",
"MGv*popup*hideToolBar.helpSection:	view-hidetoolbar",
"MGv*popup*hideToolBar.helpChapter:	mgv-5",
"MGv*popup*closeZoom.labelString:	Close All Zooms",
"MGv*popup*closeZoom.mnemonic:		Z",
"MGv*popup*closeZoom.acceleratorText:	Ctrl+Z",
"MGv*popup*closeZoom.helpSection:	view-closezoom",
"MGv*popup*closeZoom.helpChapter:	mgv-5",
...
"MGv*menuBar*help_pd*appres.helpChapter:	mgv-19",
"MGv*help_pd*appres.helpChapter:		mgv-19",
"MGv*menuBar*help_pd*cmdline.labelString:	On Command Line",
"MGv*menuBar*help_pd*cmdline.mnemonic:		L",
"MGv*menuBar*help_pd*cmdline.helpChapter:	mgv-21",
"MGv*help_pd*cmdline.helpChapter:		mgv-21",
...
"MGv*statusLine*magstepFrame.shadowType:		shadow_in",
...
"MGv*statusLine*magstepFrame*label.marginWidth:		3",
"MGv*statusLine*magstepFrame*label.marginHeight:		3",
"MGv*statusLine*nameFrame.shadowType:		shadow_in",
...
"MGv*statusLine*name.marginWidth:		3",
"MGv*statusLine*name.marginHeight:		3",
"MGv*statusLine*dateFrame.shadowType:		shadow_in",
...
"MGv*statusLine*date.marginWidth:		3",
"MGv*statusLine*date.marginHeight:		3",
"MGv*statusLine*trackerFrame.shadowType:		shadow_in",
...
"MGv*statusLine*tracker.marginWidth:		3",
"MGv*statusLine*tracker.marginHeight:		3",
"MGv*fileOpen_popup.title:	MGv:  File Open",
"MGv*fileOpen.pattern:		*.*ps*",
...
"MGv*bldoptsDialog.textSW.text*rows:		8",
...
"MGv*log.helpChapter:		mgv-18",
"MGv*log*logSave_popup.title:	MGv:  Log Save",
"MGv*log*logSave.pattern:	*.txt",
"MGv*log*logSave.helpChapter:	mgv-18",
...
"MGv*printDialog.helpChapter:		mgv-14",
...
"MGv*magstepDialog.helpChapter:		mgv-7",
...
"MGv*Ghostview.baseTranslations:	#replace		\\n\
	...
	<Key>osfLeft:	mgvScroll(left)			\\n\
	<Key>osfRight:	mgvScroll(right)",
"MGv*XmScrolledWindow*Ghostview.baseTranslations: #replace \\n\
	<Key>osfHelp:	wlHelpContext()			\\n\
	<Message>:	gvMessage()			\\n\
	!<Btn1Down>:	mgvZoom(begin)			\\n\
	!<Btn1Motion>:	mgvZoom(extend)			\\n\
...
"MGv*XmCascadeButton.fontList:       -*-helvetica-medium-r-normal--12-*-*-*-*-*-iso8859-1",
"MGv*XmCascadeButtonGadget.fontList: -*-helvetica-medium-r-normal--12-*-*-*-*-*-iso8859-1",
"MGv*XmMenuShell*fontList:           -*-helvetica-medium-r-normal--12-*-*-*-*-*-iso8859-1",
