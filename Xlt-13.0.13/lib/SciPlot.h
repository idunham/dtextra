/* $Id: SciPlot.h,v 1.7 2001/08/27 14:30:42 amai Exp $ */
/*----------------------------------------------------------------------------
...
Boolean SciPlotPSCreateFancy (SciPlotWidget w, char *filename, int drawborder, char *titles, Boolean usecolor);
...
Cardinal SciPlotMrmInitialize(void);

Widget XltCreateSciPlot(Widget parent, char *name, Arg *al, Cardinal ac);
