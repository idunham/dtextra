/*-----------------------------------------------------------------------------
 * $Header: /cvsroot/xlt/Xlt/lib/ListTreeP.h,v 1.5 2001/08/16 20:12:18 dannybackx Exp $
...
} XltListTreeClassPart;

typedef XltListTreeClassPart ListTreeClassPart;

typedef struct _XltListTreeClassRec {
  CoreClassPart core_class;
  XmPrimitiveClassPart primitive_class;
  XltListTreeClassPart ListTree_class;
} XltListTreeClassRec;

typedef XltListTreeClassRec ListTreeClassRec;

extern ListTreeClassRec listtreeClassRec;
extern XltListTreeClassRec xltListtreeClassRec;
...
/*      Dimension       LabelSpacing; */
  ...
  XltListTreeItem *first,		/* always points to a top level entry */
   *highlighted, *drop_highlighted;

  XtIntervalId timer_id;	/* timer for double click test */
  XltListTreeItem *timer_item;	/* item to make sure both clicks */
  ...
  XltListTreeItem *topItem;        /* first visible item on screen */
...
typedef XltListTreePart ListTreePart;

typedef struct _XltListTreeRec {
  CorePart core;
  XmPrimitivePart primitive;
  XltListTreePart list;
} XltListTreeRec;

typedef XltListTreeRec ListTreeRec;
