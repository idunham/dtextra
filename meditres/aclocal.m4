...
dnl
dnl $Header: /cvsroot/xlt/Xlt/ac_find_motif.m4,v 1.3 2004/09/23 21:02:48 rwscott Exp $
dnl
...
dnl LessTif CVS $Id: ac_find_motif.m4,v 1.3 2004/09/23 21:02:48 rwscott Exp $
dnl
...
if test "$with_motif" != "no"; then
	...
	AC_DEFINE(HAVE_MOTIF, 1, Define if the Motif library is available)
else
        with_motif="no"
fi
#
...
if test "$lt_cv_libxp" = "yes"; then
  AC_DEFINE(HAVE_LIB_XP, 1, Define is the Xp library is available)
  LT_HAVE_XP="yes"
else
  LT_HAVE_XP="no"
fi
